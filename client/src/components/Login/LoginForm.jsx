      ...
      <div >
          ...
          <div>
            <MDBNavbar dark expand="md" fixed="top">
              <MDBContainer>
                <MDBNavbarBrand>
                  <strong className="white-text">DOCFLOW</strong>
                </MDBNavbarBrand>
              ...
              <MDBRow>
                ...
                >
                  ...
                  <h6 className="mb-4">
                        Повышение качества и эффективности процесса работы сотрудников с
                    внутренними документами организации за счет разработки более эффективной 
                    и рациональной автоматизированной системы учета документации 
                    и контроля исполнительной дисциплины.
                  </h6>
                  <Link  to="/about"> 
